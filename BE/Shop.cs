...
namespace BE
{
    public class Shop
    {
        ...
        public Shop(Shop t)
        {
            ...
            address.latitude = t.address.latitude;
            address.longitude = t.address.longitude ;
            this.address = address;
            this.phone = t.phone;
        ...
        public Shop(int id, string name, Address address, string phone, string webSite, string facebook,Image image)
        {
